    ...
    <div class="container">
        ...
        <div class="containerOther">
            <table class="table">
                ...
                <tr>
                    <td>{{ $data['numberOfFailure'] }}</td>
                    <td class="focusColumn">{{ $data['endObservationTime'] }}</td>
                    <td>{{ $data['total'] }}</td>
                    <td>{{ $data['slope'] }}</td>
                    <td>{{ $data['lambda'] }}</td>
                    <td>{{ $data['eta'] }}</td>
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($time as $index => $masa)
                        <tr>
                            <th>{{ $data['time'] }}</td>
                            <td>{{ $data['instantenousMtbfs'] }}</td>
                            <td>{{ $data['cumulativeMtbfs'] }}</td>
                            <td>{{ $data['predictedNumberFailures'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
