<div>
    <div class="w-full p-6 flex flex-col gap-3">
        ...
        <div class="flex bg-white rounded-lg shadow-md p-6 gap-2">
            {{-- Table Result --}}
            ...
            <div class="fixed right-10 flex flex-col w-auto gap-2" x-data="{ open: false, viewMore: 'View More!'}" x-cloak>
                <button x-tooltip="viewMore" x-on:click="open = ! open" x-on:click.outside="open = false"
                    class="disabled:bg-gray-200 disabled:text-gray-500 bg-blue-200 p-2 rounded-lg shadow-md cursor-pointer hover:bg-blue-200 hover:text-blue-500">
                    <x-icons.hamburger />
                </button>
                <div x-show="open" class="flex flex-col gap-2"
                    x-data="{ refreshPage: 'Refresh!', checkBoxBounds: 'View Bounds', table: 'View Table', generatePdf: 'Export to PDF'}"
                >
                    ...
                    <button x-tooltip="checkBoxBounds" wire:click="checkBoxBounds" value="0" class="disabled:bg-gray-200 disabled:text-gray-500 bg-indigo-200 p-2 rounded-lg shadow-md cursor-pointer hover:bg-blue-200 hover:text-blue-500">
                        <x-icons.view-column />
                    </button>
                    <button x-tooltip="table" wire:click="openTable()" {{ $openTable ? '' : 'disabled' }}
                    ...
                    <button x-tooltip="generatePdf"
                        ...
                        wire:click="isGeneratePdf" class="disabled:bg-gray-200 disabled:text-gray-500 bg-yellow-200 p-2 rounded-lg shadow-md cursor-pointer hover:bg-blue-200 hover:text-blue-500">
                        <x-icons.document />
                    </button>
                </div>
            </div>
