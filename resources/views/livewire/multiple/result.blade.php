        ...
        <div class="flex bg-white rounded-lg shadow-md gap-2">
            ...
            <div class="w-full flex flex-col gap-6 rounded-lg">
                <table class="rounded-xl w-full border border-separate">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="2" class="border py-1 px-2 w-[60%]">{{ __('Number of System, K') }}</td>
                            <td class="border py-1 px-2 text-center">
                                <input
                                    wire:keydown.enter="inputNumberOfFailure()"
                                    wire:model.debounce.500ms="numberOfSystem"
                                    type="text"
                                    placeholder="0"
                                    class="border-[#ffe93f] p-0 rounded-lg w-24 text-center bg-[#fdf4b2] cursor-pointer"
                                    @if($numberOfSystem == 0) onfocus="this.value=''" @endif
                                >
                            </td>
                        </tr>
                        <tr>
                            <td class="border py-1 px-2 w-[60%]">{{ __('Total No of failure for all system') }}</td>
                            <td class="border py-1 px-2 text-center">n =</td>
                            <td class="border py-1 px-2 text-center">{{ $totalNumberOfFailureAllSystem }}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border py-1 px-2 text-center">
                                <input
                                    ...
                                    wire:model.debounce.500ms="endObservationTime"
                                    type="text"
                                    placeholder="0"
                                    class="border-[#ffe93f] p-0 rounded-lg w-24 text-center bg-[#fdf4b2] cursor-pointer"
                        ...
                        <tr>
                            ...
                            <td class="border py-1 px-2 text-center">{{ number_format($total,2) }}</td>
                        </tr>
                        <tr>
                ...
                <table class="rounded-xl w-full border border-separate">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border py-1 px-2 {{ $checkBoxBounds ? 'w-[10%]' : 'w-[20%]' }} text-center">{{ $valueFailureRate ? number_format($valueFailureRate, 4) : '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="border py-1 px-2 {{ $checkBoxBounds ? 'w-[10%]' : 'w-[20%]' }} text-center"></td>
                            <td class="border py-1 px-2 {{ $checkBoxBounds ? 'w-[10%]' : 'w-[20%]' }} text-center">{{ $valueSurviveToAge ? number_format($valueSurviveToAge, 3) : '' }}</td>
                        </tr>
                        <tr>
                            <td colspan="2" class="border py-1 px-2 w-[60%] text-right rounded-bl-lg">{{ __('Probability that the system will fail to age (𝑡+𝑑)') }}</td>
                            <td class="border py-1 px-2 {{ $checkBoxBounds ? 'w-[10%]' : 'w-[20%]' }} text-center"></td>
                            <td class="border py-1 px-2 {{ $checkBoxBounds ? 'w-[10%]' : 'w-[20%]' }} text-center rounded-br-lg">{{ $valueFailToAge ? number_format($valueFailToAge, 3) : '' }}</td>
                        </tr>
                ...
                <table class="rounded-xl w-full border border-separate">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" class="border py-1 px-2 rounded-bl-lg {{ $checkBoxBounds ? 'w-[70%]' : 'w-[80%]' }}">{{ __('Optimum time to overhaul') }}</td>
                            <td class="border py-1 px-2 rounded-br-lg {{ $checkBoxBounds ? 'w-[10%]' : 'w-[20%]' }} text-center">{{ $optimumTimeToOverhaul ? number_format($optimumTimeToOverhaul, 3) : 0 }}</td>
                            @if ($checkBoxBounds)
                                <td class="w-[10%]"></td>
                                <td class="w-[10%]"></td>
                            @endif
                    ...
                    <tbody>
                        <tr>
                            ...
                            @if ($checkBoxBounds)
                                ...
                                <td class="border py-1 px-2 text-center w-[10%]">{{ $resulLnCumFailureTime !== null ? number_format($resulLnCumFailureTime, 3) : '' }}</td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            @if ($checkBoxBounds)
                                ...
                                <td class="border py-1 px-2 text-center w-[10%]">{{ $value2 !== null  ? number_format($value2, 3) : '' }}</td>
                            @endif
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="border py-1 px-2 {{ $checkBoxBounds ? 'w-[10%]' : 'w-[20%]' }} text-center">{{ $betaAfterChange ? $betaAfterChange : '' }}</td>
